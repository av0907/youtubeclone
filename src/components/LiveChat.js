...
const LiveChat = () =>{
    ...
    return <div className="w-full mr-2">
                <div className="font-bold mt-3">Live Chat</div>
                <div className="p-1 m-0 mb-0 ml-0 w-full border border-1 bg-slate-100 h-[440px] overflow-y-scroll flex flex-col-reverse" > 
